;(function(Matter) {
    ...
    class SoccerSim {
        ...
        createFieldObjects(){
            ...
            // Goal back posts
            let blueGoal = Bodies.rectangle(fieldWidth/2, 0.07 * fieldHeight, 0.25*fieldWidth, 4, {isStatic:true, render: {fillStyle : black}});
            let yellowGoal = Bodies.rectangle(fieldWidth/2, 0.93 * fieldHeight, 0.25*fieldWidth, 4, {isStatic:true, render: {fillStyle : black}});

            // Goal areas
            let yellowArea = Bodies.rectangle(fieldWidth/2, 0.92 * fieldHeight, 0.24*fieldWidth, 14, {isStatic: true, isSensor:true,render: {fillStyle : yellow}});
            let blueArea = Bodies.rectangle(fieldWidth/2, 0.08 * fieldHeight, 0.24*fieldWidth, 14, {isStatic: true, isSensor:true,render: {fillStyle : blue}});
